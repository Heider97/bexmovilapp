...
class ModalProductInfo extends StatefulWidget {
  const ModalProductInfo({super.key});

  @override
  State<ModalProductInfo> createState() => _ModalProductInfoState();
}

class _ModalProductInfoState extends State<ModalProductInfo> {
