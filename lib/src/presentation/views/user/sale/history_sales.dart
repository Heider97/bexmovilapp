...
class _HistorySaleState extends State<HistorySale> {
  ...
  Widget build(BuildContext context) {
    ...
    return  Scaffold(
      ...
      child: Padding(
        padding: const  EdgeInsets.only(bottom: 30, right: 20, left: 20, top: 48),
        child: Column(
          children: [
            Row(
            ...
            Container(
              ...
              child: const  Text("Historial De Ventas: ", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20))
            ),
                    ...
                    child: ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) => Padding(
                          ...
                          child: CardSale(
                            ...
                            client: "Pandapan", 
                            codeSale: "Q098788E", 
                            eventCard: () => Navigator.push(context, MaterialPageRoute(builder: (context) =>  DetailsSale(dataSales: [],))), 
