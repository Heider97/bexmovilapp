...
/// Local imports
import 'package:bexmovil/src/utils/resources/sample_view.dart';
import '../../../../../utils/resources/mobile_image_converter.dart'
...
class GettingStartedSignaturePad extends SampleView {
  ...
  const GettingStartedSignaturePad({super.key});
    ...
    return Column(children: <Widget>[
      ...
      Align(
        ...
        child: Padding(
          ...
          child: Text(r'Gran Total : $1220.89',
              ...
              child: Material(
                ...
                child: Center(
                  child: Padding(
                    ...
                    child: AppText.bodyMedium('Confirmar Pedido',
                        color: Colors.white),
                  ),
                ),
              ),
      ...
      return ListView(shrinkWrap: true, children: <Widget>[
        ...
        SfSliderTheme(
            data: SfSliderThemeData(
              ...
              overlayRadius: 15,
              activeLabelStyle: TextStyle(color: model.textColor, fontSize: 14),
              inactiveLabelStyle:
