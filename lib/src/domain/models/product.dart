class Product {
  ...
  int? codGrupoProducto;
  int? estadoProducto;
  String? pluClaProducto;
  int? codMarcaMCodProveedor;
  String? codLinea;
  int? impConsumo;
  int? impEstampilla;
  String? referencia;
  ...
  factory Product.fromJson(Map<String, dynamic> json) => Product(
        ...
        precioProductoPrecio: json['precioproductoprecio'],
        dctoProductoPrecio: json['DCTOPRODUCTOPRECIO'],
        icoPrecioMin: json['ICO.PRECIOMIN'],
